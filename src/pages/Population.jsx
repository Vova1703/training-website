    ...
    <main className="container px-4 py-4">
      <div className="row">
        ...
        <article className="col-md-9">
          <h2 className="h2 text-success mb-4">Ареал поширення Рисів</h2>
          ...
          <section id="subcontinents" className="mt-4">
            ...
            <div className="collapse" id="subcontinentsList">
              <ul className="list-group mb-3">
                <li className="list-group-item">Північноамериканський субконтинент</li>
                <li className="list-group-item">Євразійський субконтинент</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biogeographic" className="mt-4">
            ...
            <div className="collapse" id="biogeographicList">
              <ul className="list-group mb-3">
                <li className="list-group-item">Бореальна зона</li>
                <li className="list-group-item">Помірна лісова зона</li>
                <li className="list-group-item">Субальпійська зон</li>
                <li className="list-group-item">Альпійська зона</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biomes" className="mt-4">
            ...
            <div className="collapse" id="biomesList">
              <ul className="list-group">
                <li className="list-group-item">Бореальні ліси</li>
