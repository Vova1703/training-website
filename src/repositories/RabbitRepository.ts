...
export class RabbitRepository {
    ...
    // Метод для часткового оновлення даних про рись (оновлення лише вказаних полів)
